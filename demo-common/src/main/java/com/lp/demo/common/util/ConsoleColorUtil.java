...
public class ConsoleColorUtil {
    ...
    public static void printSingleColor(String content, int colorCode, int styleCode) {
        System.out.println("[" + DateUtil.getSimpleDateFormat() + "]  " + "\033["+ colorCode + ";" + styleCode + "m " + content + "\033[0m");
    }
    ...
    public static void printDefaultColor(String content) {
        System.out.println("[" + DateUtil.getSimpleDateFormat() + "]  " + "\033["+ ConsoleColorCodeEnum.GREEN.getColorCode() + ";" + ConsoleStyleCodeEnum.DEFAULT.getStyleCode() + "m " + content + "\033[0m");
    }
