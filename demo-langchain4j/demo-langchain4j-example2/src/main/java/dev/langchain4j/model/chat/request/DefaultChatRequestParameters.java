...
public class DefaultChatRequestParameters implements ChatRequestParameters {
    ...
    protected DefaultChatRequestParameters(Builder<?> builder) {
        ...
        this.stopSequences = Utils.copyIfNotNull(builder.stopSequences); // 改动点 by lp 20250516
        this.toolSpecifications = Utils.copyIfNotNull(builder.toolSpecifications); // 改动点 by lp 20250516
